...
(function () {
  ...
  function showMatchDetail(match) {
    ...
    var html = '<table class="detail-table" role="table"><thead><tr><th>' + t('table.name') + '</th><th>' + t('table.court') + '</th><th>' + t('table.bench') + '</th><th>%</th><th>A</th><th>F</th><th>M</th></tr></thead><tbody>';
    ...
    sorted.forEach(function (item) {
      ...
      div.innerHTML =
        ...
        '<table class="detail-table stats-detail-table" role="table">' +
          '<thead><tr><th>' + t('table.court') + '</th><th>' + t('table.bench') + '</th><th>%</th><th>' + t('table.matches') + '</th><th>A</th><th>F</th><th>M</th></tr></thead>' +
          '<tbody><tr>' +
